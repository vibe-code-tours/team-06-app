...
import { updateRestaurant, deleteRestaurant, toggleRestaurantActive } from '@/lib/services/restaurantService'
...
export async function PATCH(
    ...
    const result = await toggleRestaurantActive(supabase, params.restaurantId)
